...
# Package managers
npm i -g conduit-ai@latest        # or bun/pnpm/yarn
scoop install conduit             # Windows
choco install conduit             # Windows
brew install anomalyco/tap/conduit # macOS and Linux (recommended, always up to date)
brew install conduit              # macOS and Linux (official brew formula, updated less)
sudo pacman -S conduit            # Arch Linux (Stable)
paru -S conduit-bin               # Arch Linux (Latest from AUR)
mise use -g conduit               # Any OS
nix run nixpkgs#conduit           # or github:anomalyco/conduit for latest dev branch
```
...
Conduit ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/anomalyco/conduit/releases) অথবা [conduit.ai/download](https://conduit.ai/download) থেকে ডাউনলোড করুন।
...
1. `$CONDUIT_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.conduit/bin` - ডিফল্ট ফলব্যাক
...
Conduit এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://conduit.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে Conduit কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://conduit.ai/docs)।

### অবদান (Contributing)

আপনি যদি Conduit এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### Conduit এর উপর বিল্ডিং (Building on Conduit)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা Conduit এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "conduit" ব্যবহার করেন, উদাহরণস্বরূপ "conduit-dashboard" বা "conduit-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি Conduit দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/conduit) | [X.com](https://x.com/conduit)
