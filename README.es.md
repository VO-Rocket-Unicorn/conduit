...
npm i -g conduit-ai@latest        # o bun/pnpm/yarn
scoop install conduit             # Windows
choco install conduit             # Windows
brew install anomalyco/tap/conduit # macOS y Linux (recomendado, siempre al día)
brew install conduit              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S conduit            # Arch Linux (Stable)
paru -S conduit-bin               # Arch Linux (Latest from AUR)
mise use -g conduit               # cualquier sistema
nix run nixpkgs#conduit           # o github:anomalyco/conduit para la rama dev más reciente
```
...
Conduit también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/conduit/releases) o desde [conduit.ai/download](https://conduit.ai/download).
...
1. `$CONDUIT_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.conduit/bin` - Alternativa por defecto
...
Conduit incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://conduit.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar Conduit, [**ve a nuestra documentación**](https://conduit.ai/docs).

### Contribuir

Si te interesa contribuir a Conduit, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en Conduit

Si estás trabajando en un proyecto basado en Conduit y usas "conduit" como parte del nombre, por ejemplo, "conduit-dashboard" u "conduit-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de Conduit y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/conduit) | [X.com](https://x.com/conduit)
