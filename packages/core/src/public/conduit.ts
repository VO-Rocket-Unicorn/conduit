...
/** Intentional public native API for Effect applications embedding Conduit. */
export class Service extends Context.Service<Service, Interface>()("@conduit/public/Conduit") {}
...
>()("@conduit/public/Conduit/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("Conduit.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("Conduit.sessions.switchModel")(function* (input) {
...
// TODO: Add Conduit.create(...) as the Promise facade over the same native API semantics.
