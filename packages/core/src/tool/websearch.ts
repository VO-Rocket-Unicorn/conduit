...
export class ConfigService extends Context.Service<ConfigService, Config>()("@conduit/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.CONDUIT_WEBSEARCH_PROVIDER === "exa" || process.env.CONDUIT_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.CONDUIT_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("CONDUIT_EXPERIMENTAL") || truthy("CONDUIT_ENABLE_EXA") || truthy("CONDUIT_EXPERIMENTAL_EXA"),
    enableParallel: truthy("CONDUIT_ENABLE_PARALLEL") || truthy("CONDUIT_EXPERIMENTAL_PARALLEL"),
