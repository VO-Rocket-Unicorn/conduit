...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolSettlement } from "@conduit-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@conduit/v2/ToolRegistry") {}
