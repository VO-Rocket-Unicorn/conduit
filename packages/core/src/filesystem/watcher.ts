...
declare const CONDUIT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CONDUIT_LIBC === "undefined" ? undefined : CONDUIT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@conduit/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CONDUIT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.CONDUIT_EXPERIMENTAL_FILEWATCHER) {
