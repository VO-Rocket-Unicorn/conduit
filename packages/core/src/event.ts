...
const syncCodec = (definition: Definition) => definition.data as Schema.Codec<unknown, unknown, never>
...
export class Service extends Context.Service<Service, Interface>()("@conduit/Event") {}
