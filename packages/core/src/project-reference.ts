...
export class Service extends Context.Service<Service, Interface>()("@conduit/ProjectReference") {}
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (!Flag.CONDUIT_EXPERIMENTAL_REFERENCES) return Service.of(inert)
