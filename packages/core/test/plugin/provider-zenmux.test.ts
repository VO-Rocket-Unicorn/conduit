...
import { ProviderPlugins } from "@conduit-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@conduit-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://conduit.ai/", "X-Title": "conduit" })
