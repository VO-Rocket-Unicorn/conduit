...
class Database extends Context.Service<Database, DatabaseShape>()("@conduit/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@conduit/example/UserStore") {
