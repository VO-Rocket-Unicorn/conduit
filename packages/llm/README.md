...
Schema-first LLM core for conduit. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@conduit-ai/llm"
import { OpenAI } from "@conduit-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@conduit-ai/llm/providers"
