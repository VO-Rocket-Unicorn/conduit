import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@conduit-ai/sdk/v2"
import { SessionTurn } from "@conduit-ai/ui/session-turn"
import { SessionReview } from "@conduit-ai/ui/session-review"
import { DataProvider } from "@conduit-ai/ui/context"
import { FileComponentProvider } from "@conduit-ai/ui/context/file"
import { WorkerPoolProvider } from "@conduit-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@conduit-ai/ui/logo"
import { IconButton } from "@conduit-ai/ui/icon-button"
import { ProviderIcon } from "@conduit-ai/ui/provider-icon"
import { iife } from "@conduit-ai/core/util/iife"
import { Binary } from "@conduit-ai/core/util/binary"
import { NamedError } from "@conduit-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@conduit-ai/ui/tabs"
import { MessageNav } from "@conduit-ai/ui/message-nav"
import { FileSSR } from "@conduit-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@conduit-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/conduit-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Conduit</Title>
              </Show>
              <Meta name="description" content="conduit - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/conduit"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
