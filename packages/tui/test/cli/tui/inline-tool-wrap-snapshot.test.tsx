...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "CONDUIT.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/conduit/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/conduit (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/conduit/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/conduit/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const CONDUIT_DB|CONDUIT_DB|CONDUIT_DEV|Global\\.Path\\.data|data =" in packages/conduit/src (115 matches)',
  },
] as const
