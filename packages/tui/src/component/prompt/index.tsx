...
import type { AssistantMessage, FilePart, UserMessage } from "@conduit-ai/sdk/v2"
...
import { CONDUIT_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useConduitKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.CONDUIT_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
