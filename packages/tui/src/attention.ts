...
import defaultSoundPath from "@conduit-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@conduit-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@conduit-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@conduit-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@conduit-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@conduit-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "conduit"
const DEFAULT_PACK_ID = "conduit.default"
