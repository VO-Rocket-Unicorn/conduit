...
Practical reference for the current tool-migration state in `packages/conduit`.
...
Tool tests should use the existing Effect helpers in `packages/conduit/test/lib/effect.ts`:
