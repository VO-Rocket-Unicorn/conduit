...
import { which } from "@conduit-ai/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@conduit-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@conduit/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.CONDUIT_FAKE_VCS)
