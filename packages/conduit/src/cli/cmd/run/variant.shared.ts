...
//
// The saved variant persists across sessions in ~/.local/state/conduit/model.json
...
class Service extends Context.Service<Service, VariantService>()("@conduit/RunVariant") {}
