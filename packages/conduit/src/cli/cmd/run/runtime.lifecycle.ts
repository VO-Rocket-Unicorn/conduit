...
import { openEditor } from "@conduit-ai/tui/editor"
import { registerConduitKeymap } from "@conduit-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerConduitKeymap(keymap, renderer, input.tuiConfig)
