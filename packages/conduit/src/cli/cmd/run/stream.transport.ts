...
import type { Event, GlobalEvent, ConduitClient } from "@conduit-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@conduit/RunStreamTransport") {}
