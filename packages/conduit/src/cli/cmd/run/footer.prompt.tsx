...
import { normalizePromptContent } from "@conduit-ai/tui/editor"
...
import { CONDUIT_BASE_MODE, useBindings } from "@conduit-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Conduit" } satisfies SlashOption,
    ]
