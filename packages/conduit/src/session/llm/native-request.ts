import type { JsonSchema, LLMRequest, ProviderMetadata } from "@conduit-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@conduit-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @conduit-ai/llm request objects from conduit's session/AI SDK-shaped data.
  return LLM.request({
