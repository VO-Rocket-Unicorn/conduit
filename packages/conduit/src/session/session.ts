...
import { Slug } from "@conduit-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@conduit-ai/llm"
...
import { PartTable, SessionTable } from "@conduit-ai/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@conduit-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".conduit", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@conduit/Session") {}
