...
import { AgentAttachment, FileAttachment, Prompt, ReferenceAttachment, Source } from "@conduit-ai/core/session/prompt"
...
import { LLMEvent } from "@conduit-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@conduit/SessionPrompt") {}
