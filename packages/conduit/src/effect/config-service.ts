 ...
 *   "@conduit/ServerAuthConfig",
 *   {
 *     password: Config.string("CONDUIT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CONDUIT_SERVER_USERNAME").pipe(Config.withDefault("conduit")),
 *   },
 * ) {}
 *
