...
<html>
  <head>
    <title>Conduit - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>Conduit - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "conduit"
      output.headers["User-Agent"] = `conduit/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
