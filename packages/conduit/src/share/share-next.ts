import type * as SDK from "@conduit-ai/sdk/v2"
...
import { SessionShareTable } from "@conduit-ai/core/share/sql"
...
const disabled = process.env["CONDUIT_DISABLE_SHARE"] === "true" || process.env["CONDUIT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@conduit/ShareNext") {}
