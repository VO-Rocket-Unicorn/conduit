...
import { AccountStateTable, AccountTable } from "@conduit-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@conduit/AccountRepo") {}
