...
import type { AssistantMessage as ConduitAssistantMessage, Message } from "@conduit-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<ConduitAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ConduitAssistantMessage, "role"> &
  Partial<Pick<ConduitAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@conduit/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@conduit/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@conduit/ACPUsage") {}
