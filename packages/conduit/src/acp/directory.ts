...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@conduit/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@conduit/ACPDirectory") {}
