...
>()("@conduit/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@conduit/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.CONDUIT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.CONDUIT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-conduit-directory"] || process.cwd()
}
