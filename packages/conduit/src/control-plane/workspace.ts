...
import { EventSequenceTable, EventTable } from "@conduit-ai/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@conduit/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CONDUIT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CONDUIT_WORKSPACE_ID: config.id,
        CONDUIT_EXPERIMENTAL_WORKSPACES: "true",
