...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/conduit.git")).toEqual({ owner: "sst", repo: "conduit" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/conduit")).toEqual({ owner: "sst", repo: "conduit" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/conduit.git")).toEqual({ owner: "sst", repo: "conduit" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/conduit")).toEqual({ owner: "sst", repo: "conduit" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/conduit.git")).toEqual({ owner: "sst", repo: "conduit" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/conduit")).toEqual({ owner: "sst", repo: "conduit" })
})
