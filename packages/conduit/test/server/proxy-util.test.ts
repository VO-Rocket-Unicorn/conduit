...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips conduit-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-conduit-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-conduit-directory")).toBeNull()
      expect(result.get("x-conduit-workspace")).toBeNull()
