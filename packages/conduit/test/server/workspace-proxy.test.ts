...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips conduit-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-conduit-directory"]).toBeUndefined()
      expect(forwarded["x-conduit-workspace"]).toBeUndefined()
