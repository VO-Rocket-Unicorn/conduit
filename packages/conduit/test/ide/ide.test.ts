...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CONDUIT_CALLER", () => {
    process.env["CONDUIT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CONDUIT_CALLER", () => {
    process.env["CONDUIT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CONDUIT_CALLER", () => {
    process.env["CONDUIT_CALLER"] = "unknown"
