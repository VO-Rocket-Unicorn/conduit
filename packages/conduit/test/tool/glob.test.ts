  ...
  references.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "conduit-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "conduit-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "conduit-glob-reference/repo",
        },
      },
    },
  )
