...
const releaseId = process.env.CONDUIT_RELEASE
if (!releaseId) throw new Error("CONDUIT_RELEASE is required")

const version = process.env.CONDUIT_VERSION
if (!version) throw new Error("CONDUIT_VERSION is required")
...
const macxTarGz = "conduit-desktop-mac-x64.app.tar.gz"
const macaTarGz = "conduit-desktop-mac-arm64.app.tar.gz"
