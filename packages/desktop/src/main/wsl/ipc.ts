...
export function registerWslIpcHandlers(controller: WslServersController) {
  ...
  ipcMain.handle("wsl-servers-probe-conduit", (_event: IpcMainInvokeEvent, name: string) =>
    controller.probeConduit(requireWslIpcString("distro", name)),
  )
  ipcMain.handle("wsl-servers-install-conduit", (_event: IpcMainInvokeEvent, name: string) =>
    controller.installConduit(requireWslIpcString("distro", name)),
  )
...
function registerUnavailableWslIpcHandlers() {
  ...
  ipcMain.handle("wsl-servers-probe-conduit", unavailable)
  ipcMain.handle("wsl-servers-install-conduit", unavailable)
