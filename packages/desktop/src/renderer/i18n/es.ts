export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Conduit",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Conduit. ¿Quieres instalarla y reiniciar?",
