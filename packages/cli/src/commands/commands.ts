...
declare const CONDUIT_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof CONDUIT_CLI_NAME === "string" ? CONDUIT_CLI_NAME : "conduit", {
  description: "Conduit 2.0 preview command line interface",
  commands: [
    Spec.make("debug", {
