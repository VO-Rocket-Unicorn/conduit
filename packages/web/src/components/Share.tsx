...
import { IconConduit } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "conduit/session/message-v2"
import type { Message } from "conduit/session/message"
import type { Session } from "conduit/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.conduit_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.conduit_name}>
                    <IconConduit width={16} height={16} />
                  </div>
