...
Opret `.conduit/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Conduit-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Conduit [config](/docs/config):
...
- Globalt: `~/.config/conduit/commands/`
- Pr. projekt: `.conduit/commands/`
...
conduit indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
