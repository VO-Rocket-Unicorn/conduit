...
Her er alle de innebygde verktøyene som er tilgængelige i Conduit.
...
:::note
Dette verktøyet er bare tilgængelig når `CONDUIT_EXPERIMENTAL_LSP_TOOL=true` (eller `CONDUIT_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Conduit-leverandøren eller når miljøvariabelen `CONDUIT_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
