---
title: TUI
description: Brug af Conduit-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Conduit giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Conduit starter TUI for den nuværende mappe.
...
Når du bruger Conduit TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Conduit. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Conduit. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `conduit.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Conduit venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `conduit.default`.
