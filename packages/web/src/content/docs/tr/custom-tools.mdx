---
title: Özel Araçlar
description: LLM'un conduit'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. conduit'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.conduit/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/conduit/tools/` içine yerleştirerek.
