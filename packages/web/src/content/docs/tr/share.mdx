---
title: Paylasim
description: conduit konusmalarini genel baglantilarla paylasin.
---

conduit'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda conduit:
...
conduit, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak conduit manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `conduit.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda conduit kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
