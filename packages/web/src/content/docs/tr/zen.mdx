---
title: Zen
description: conduit tarafından sağlanan seçilmiş modeller listesi.
---
...
Conduit Zen, Conduit ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Conduit'daki diğer sağlayıcılar gibi çalışır. Conduit Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Conduit kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Conduit ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Conduit Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Conduit Zen, Conduit'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Conduit Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Conduit Zen'i seçin ve API anahtarınızı yapıştırın.
...
Conduit yapılandırmanızdaki [model id](/docs/config/#models) `conduit/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `conduit/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Conduit'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Conduit'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Conduit'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Conduit'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Conduit Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Conduit ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
