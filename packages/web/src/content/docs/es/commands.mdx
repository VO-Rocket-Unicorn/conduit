...
Crear `.conduit/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Conduit o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Conduit [config](/docs/config):
...
conduit incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
