...
Kreiraj `.conduit/commands/test.md`:
...
Možete dodati prilagođene komande kroz Conduit konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Conduit [config](/docs/config):
...
- Globalno: `~/.config/conduit/commands/`
- Po projektu: `.conduit/commands/`
...
Conduit uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
