---
title: Zen
description: Kurirana lista modela koje nudi Conduit.
---
...
Conduit Zen je lista testiranih i provjerenih modela koje pruža Conduit tim.

Zen radi kao i svaki drugi provajder u Conduit. Prijavite se na Conduit Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili Conduit.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s Conduit.
:::
...
Conduit Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

Conduit Zen radi kao i svaki drugi provajder u Conduit.

1. Prijavite se na **<a href={console}>Conduit Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite Conduit Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj Conduit konfiguraciji koristi format
`conduit/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `conduit/gpt-5.5`.
...
- DeepSeek V4 Flash Free je dostupan na Conduit ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na Conduit ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na Conduit ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na Conduit ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u Conduit.
