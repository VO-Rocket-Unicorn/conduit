---
title: TUI
description: Korištenje korisničkog interfejsa Conduit terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Conduit pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Conduit pokreće TUI za trenutni direktorij.
...
Kada koristite Conduit TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Conduit. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Conduit. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `conduit.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Conduit čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `conduit.default`.
