---
title: LSP serveri
description: Conduit se integriše sa vašim LSP serverima.
---

Conduit se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Conduit dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `CONDUIT_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i conduit otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj conduit konfiguraciji.
