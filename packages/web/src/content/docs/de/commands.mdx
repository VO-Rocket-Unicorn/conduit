...
Erstellen Sie `.conduit/commands/test.md`:

```md title=".conduit/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Conduit-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Conduit [config](/docs/config):

```json title="conduit.jsonc" {4-12}
{
...
- Global: `~/.config/conduit/commands/`
- Pro Projekt: `.conduit/commands/`

```markdown title="~/.config/conduit/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".conduit/commands/component.md"
---
...
```md title=".conduit/commands/create-file.md"
---
...
```md title=".conduit/commands/analyze-coverage.md"
---
...
```md title=".conduit/commands/review-changes.md"
---
...
```md title=".conduit/commands/review-component.md"
---
...
Conduit enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
