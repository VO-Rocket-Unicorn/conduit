---
title: Teilen
description: Teile Conduit-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Conduit-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Conduit Folgendes:
...
Conduit hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Conduit den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`conduit.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du conduit in deiner Organisation einsetzt.
