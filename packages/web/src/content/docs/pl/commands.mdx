...
Utwórz `.conduit/commands/test.md`:
...
Możesz zdefiniować polecenia w `conduit.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji conduit:
...
- Globalnie: `~/.config/conduit/commands/`
- Na projekt: `.conduit/commands/`
...
conduit zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
