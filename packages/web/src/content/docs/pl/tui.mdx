---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala conduit.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

conduit zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie conduit uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI conduit, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do conduit. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij conduit. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `conduit.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Conduit czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `conduit.default`.
