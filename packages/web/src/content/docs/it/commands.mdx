...
Puoi aggiungere comandi personalizzati tramite la config di Conduit o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Conduit:
...
- Globale: `~/.config/conduit/commands/`
- Per progetto: `.conduit/commands/`
...
conduit include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
