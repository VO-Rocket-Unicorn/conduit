---
title: TUI
description: استخدام واجهة المستخدم TUI في Conduit.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Conduit واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Conduit إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Conduit في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Conduit. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Conduit. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `conduit.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Conduit بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `conduit.default`.
