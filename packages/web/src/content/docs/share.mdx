---
title: Share
description: Share your Conduit conversations.
---

Conduit's share feature allows you to create public links to your Conduit conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Conduit:
...
Conduit supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Conduit uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `conduit.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using conduit in your organization.
