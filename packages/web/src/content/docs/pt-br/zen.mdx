---
title: Zen
description: Lista selecionada de modelos fornecidos pelo Conduit.
---
...
O Conduit Zen é uma lista de modelos testados e verificados fornecidos pela equipe do Conduit.

O Zen funciona como qualquer outro provedor no Conduit. Você faz login no Conduit Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o Conduit.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o Conduit.
:::
...
O Conduit Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O Conduit Zen funciona como qualquer outro provedor no Conduit.

1. Você faz login no **<a href={console}>Conduit Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Conduit Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do Conduit usa o formato `conduit/<model-id>`. Por exemplo, para GPT 5.5, você usaria `conduit/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no Conduit por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no Conduit por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no Conduit por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no Conduit por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o Conduit também.
