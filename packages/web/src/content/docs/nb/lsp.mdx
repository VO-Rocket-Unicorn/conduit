---
title: LSP-servere
description: conduit integreres med LSP-serverne dine.
---

Conduit kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Conduit kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `CONDUIT_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og conduit åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Conduit-konfigurasjonen.
