...
Opprett `.conduit/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Conduit-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Conduit [config](/docs/config):
...
Conduit inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
