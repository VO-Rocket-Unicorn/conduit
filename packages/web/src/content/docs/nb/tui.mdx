---
title: TUI
description: Bruke conduit-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Conduit gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Conduit starter TUI for gjeldende katalog.
...
Når du bruker Conduit TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Conduit. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Conduit. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `conduit.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Conduit venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `conduit.default`.
