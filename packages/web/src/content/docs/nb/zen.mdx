---
title: Zen
description: Utvalgt liste over modeller levert av Conduit.
---
...
Conduit Zen er en liste over testede og verifiserte modeller levert av Conduit-teamet.

Zen fungerer som enhver annen leverandør i Conduit. Du logger inn på Conduit Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Conduit.
:::
...
Conduit Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Conduit Zen fungerer som enhver annen leverandør i Conduit.

1. Du logger inn på **<a href={console}>Conduit Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Conduit Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Conduit-konfigurasjonen din
bruker formatet `conduit/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `conduit/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på Conduit i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på Conduit i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på Conduit i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Conduit i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet Conduit Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Conduit også.
