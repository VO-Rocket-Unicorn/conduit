...
import { mockConduitServer } from "../utils/mock-server"
import { expectAppVisible, expectSessionTitle } from "../utils/waits"

const directory = "C:/Conduit/ContextResizeRegression"
...
const model = { providerID: "conduit", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["conduit"],
    default: { providerID: "conduit", modelID: "claude-opus-4-6" },
  }
}
