...
import { ResizeHandle } from "@conduit-ai/ui/resize-handle"
...
import { Session, type Message } from "@conduit-ai/sdk/v2/client"
...
import { toaster } from "@conduit-ai/ui/toast"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://conduit.ai/desktop-feedback")}
      renderPanel={() =>
