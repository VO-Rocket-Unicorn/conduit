import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@conduit-ai/sdk/v2/client"
...
import { List, type ListRef } from "@conduit-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "conduit"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.conduitZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.conduitZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.conduitZen.visit.prefix")}
                <Link href="https://conduit.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.conduitZen.visit.link")}
                </Link>
                {language.t("provider.connect.conduitZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
