...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "conduit", key: "dialog.provider.conduit.note" },
  { match: (id: string) => id === "conduit-go", key: "dialog.provider.conduitGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "conduit" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "conduit" || item.id === "conduit-go"}>
