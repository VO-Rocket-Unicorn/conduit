...
beforeAll(async () => {
  ...
  mock.module("@conduit-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@conduit-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@conduit-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@conduit-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
