...
export const dict = {
  ...
  "dialog.provider.conduit.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.conduit.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.conduitGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Conduit",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Conduit.",
  ...
  "provider.connect.conduitZen.line1":
    "Conduit Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.conduitZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.conduitZen.visit.prefix": "Besøk ",
  "provider.connect.conduitZen.visit.link": "conduit.ai/zen",
  "provider.connect.conduitZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Conduit.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Conduit.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i conduit.json",
  ...
  "dialog.server.description": "Bytt hvilken Conduit-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Conduit ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Conduit-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (conduit.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Conduit ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Conduit inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Conduit-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Conduit",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Conduit ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Conduit skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Conduit er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Conduit starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Conduit.",
