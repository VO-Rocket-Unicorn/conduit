export const dict = {
  ...
  "dialog.provider.conduit.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.conduit.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.conduitGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Conduit",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Conduit.",
  ...
  "provider.connect.conduitZen.line1":
    "Conduit Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.conduitZen.visit.prefix": "Odwiedź ",
  "provider.connect.conduitZen.visit.link": "conduit.ai/zen",
  "provider.connect.conduitZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Conduit.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Conduit.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w conduit.json",
  ...
  "dialog.server.description": "Przełącz serwer Conduit, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Conduit ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Conduit",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (conduit.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Conduit zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Conduit",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Conduit na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Conduit ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Conduit.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Conduit",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Conduit.",
