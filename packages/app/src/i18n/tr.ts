...
export const dict = {
  ...
  "dialog.provider.conduit.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.conduit.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.conduitGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Conduit tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Conduit'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.conduitZen.line1":
    "Conduit Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.conduitZen.visit.prefix": "",
  "provider.connect.conduitZen.visit.link": "conduit.ai/zen",
  "provider.connect.conduitZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Conduit'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Conduit'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler conduit.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Conduit sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Conduit'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Conduit ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (conduit.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Conduit henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Conduit ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Conduit Masaüstü",
  ...
  "settings.desktop.wsl.description": "Conduit sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Conduit'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Conduit'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Conduit'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Conduit'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Conduit başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Conduit'un en son sürümünü kullanıyorsunuz.",
