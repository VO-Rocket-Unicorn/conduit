export const dict = {
  ...
  "dialog.provider.conduit.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.conduit.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.conduitGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Conduit",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Conduit-u.",
  ...
  "provider.connect.conduitZen.line1":
    "Conduit Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.conduitZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.conduitZen.visit.prefix": "Posjeti ",
  "provider.connect.conduitZen.visit.link": "conduit.ai/zen",
  "provider.connect.conduitZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Conduit-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Conduit-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u conduit.json",
  ...
  "dialog.server.description": "Promijeni na koji se Conduit server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Conduit-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Conduit timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (conduit.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Conduit još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Conduit uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Conduit server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Conduit-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Conduit izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Conduit prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Conduit-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Conduit pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Conduit-a.",
