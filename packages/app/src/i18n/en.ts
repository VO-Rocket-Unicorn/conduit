export const dict = {
  ...
  "dialog.provider.conduit.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.conduit.tagline": "Reliable optimized models",
  "dialog.provider.conduitGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Conduit",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Conduit.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.conduitZen.line1":
    "Conduit Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.conduitZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.conduitZen.visit.prefix": "Visit ",
  "provider.connect.conduitZen.visit.link": "conduit.ai/zen",
  "provider.connect.conduitZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Conduit.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Conduit.",
  ...
  "dialog.plugins.empty": "Plugins configured in conduit.json",
  ...
  "dialog.server.description": "Switch which Conduit server this app connects to.",
  ...
  "wsl.onboarding.step.conduit": "Conduit",
  ...
  "wsl.onboarding.checkingConduit": "Checking Conduit...",
  "wsl.onboarding.checkingConduitIn": "Checking Conduit in {{distro}}...",
  "wsl.onboarding.updatingConduit": "Updating Conduit...",
  "wsl.onboarding.updatingConduitIn": "Updating Conduit in {{distro}}...",
  "wsl.onboarding.updateConduitIn": "Update Conduit in {{distro}}.",
  "wsl.onboarding.updateConduit": "Update Conduit",
  "wsl.onboarding.conduitReadyIn": "Conduit is ready in {{distro}}.",
  "wsl.onboarding.conduitReady": "Conduit is ready.",
  "wsl.onboarding.installConduitIn": "Install Conduit in {{distro}}.",
  "wsl.onboarding.installConduit": "Install Conduit",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Conduit.",
  ...
  "toast.update.description": "A new version of Conduit ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Conduit team",
  ...
  "error.chain.checkConfig": "Check your config (conduit.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Conduit does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Conduit includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Conduit Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Conduit server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Conduit",
  ...
  "settings.general.row.appearance.description": "Customise how Conduit looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Conduit follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Conduit is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Conduit launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Conduit.",
