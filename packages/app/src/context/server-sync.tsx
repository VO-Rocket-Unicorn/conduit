import type { Config, ConduitClient, Path, Project, ProviderAuthResponse, Todo } from "@conduit-ai/sdk/v2/client"
...
import { createSimpleContext, NormalizedProviderListResponse } from "@conduit-ai/ui/context"
...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: ConduitClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (scope: ServerScope, directory: string, sdk: ConduitClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => ConduitClient,
) {
  return {
...
export function createServerSyncContextInner(_serverSDK?: ServerSDK) {
  ...
  const sdkCache = new Map<string, ConduitClient>()
