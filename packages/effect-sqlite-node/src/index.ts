...
export const TypeId: TypeId = "~@conduit-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@conduit-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@conduit-ai/effect-sqlite-node/NodeSqliteClient")
