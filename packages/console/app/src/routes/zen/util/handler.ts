...
import { and, Database, eq, isNull, lt, or, sql } from "@conduit-ai/console-core/drizzle/index.js"
import { KeyTable } from "@conduit-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@conduit-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@conduit-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@conduit-ai/console-core/util/date.js"
import { Identifier } from "@conduit-ai/console-core/identifier.js"
import { Billing } from "@conduit-ai/console-core/billing.js"
import { Actor } from "@conduit-ai/console-core/actor.js"
import { WorkspaceTable } from "@conduit-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@conduit-ai/console-core/model.js"
import { Subscription } from "@conduit-ai/console-core/subscription.js"
import { BlackData } from "@conduit-ai/console-core/black.js"
import { UserTable } from "@conduit-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@conduit-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@conduit-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@conduit-ai/console-core/lite.js"
import { Resource } from "@conduit-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-conduit-session") ?? ""
    const requestId = input.request.headers.get("x-conduit-request") ?? ""
    const ocClient = input.request.headers.get("x-conduit-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-conduit-request")
          headers.delete("x-conduit-session")
          headers.delete("x-conduit-project")
          headers.delete("x-conduit-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://conduit.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://conduit.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://conduit.ai/workspace/${authInfo.workspaceID}/members`
