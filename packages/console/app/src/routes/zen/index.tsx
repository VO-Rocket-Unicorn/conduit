...
import compareVideo from "../../asset/lander/conduit-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/conduit-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="conduit:auth" content={loggedin() ? "true" : "false"} />
