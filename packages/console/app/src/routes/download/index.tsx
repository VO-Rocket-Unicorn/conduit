...
import desktopAppIcon from "../../asset/lander/conduit-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://conduit.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>conduit.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g conduit-ai")}>
                <code>
                  npm i -g <strong>conduit-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g conduit-ai")}>
                <code>
                  bun add -g <strong>conduit-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/conduit")}>
                <code>
                  brew install <strong>anomalyco/tap/conduit</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S conduit")}>
                <code>
                  paru -S <strong>conduit</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask conduit-desktop")}>
                <code>
                  brew install --cask <strong>conduit-desktop</strong>
                </code>
                <CopyStatus />
              </button>
