...
const tableBucketName = `conduit-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `conduit-${$app.stage}-lake-ingest`,
    destination: "iceberg",
