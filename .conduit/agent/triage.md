...
Desktop application and browser-based app issues, including `conduit web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core conduit server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Conduit Zen, Conduit Go, and billing issues.
