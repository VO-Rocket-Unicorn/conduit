...
- PR #13942: https://github.com/anomalyco/conduit/pull/13942

## Do Not Translate (Locale Additions)

- `Conduit` (preserve casing in prose; keep `conduit` only when it is part of commands, package names, paths, or code)
- `Conduit Zen`
- `Conduit CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `conduit` in prose when referring to the product name; use `Conduit`
