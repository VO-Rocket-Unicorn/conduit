...
- PR #10809: https://github.com/anomalyco/conduit/pull/10809
- PR #11496: https://github.com/anomalyco/conduit/pull/11496

## Do Not Translate (Locale Additions)

- `Conduit` (preserve casing in prose; keep `conduit` only in commands, package names, paths, or code)
- `Conduit CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
