...
Use this folder for locale-specific translation guidance that supplements `.conduit/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/conduit/pull/12345

## Do Not Translate (Locale Additions)

- `Conduit` (preserve casing)
