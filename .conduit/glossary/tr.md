...
- PR #15835: https://github.com/anomalyco/conduit/pull/15835

## Do Not Translate (Locale Additions)

- `Conduit` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `conduit` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Conduit` in prose, `conduit` only for exact technical identifiers
...
- Avoid changing `conduit` to `Conduit` inside commands, URLs, package names, or code literals
