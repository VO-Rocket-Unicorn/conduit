...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/conduit/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/conduit...\n")
...
console.log("Fetching npm all-time downloads for conduit-ai...\n")
const npmDownloads = await fetchNpmDownloads("conduit-ai")
